  ...
  template: `
    <header class="site-header">
      <div class="wrap header-inner">
        <a routerLink="/" class="brand">Galera</a>
        ...
        <nav class="nav" [class.open]="open()">
          <a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{ exact: true }" (click)="open.set(false)">Taller</a>
          <a routerLink="/prensas" routerLinkActive="active" (click)="open.set(false)">Prensas</a>
          <a routerLink="/bono" routerLinkActive="active" (click)="open.set(false)">Bono</a>
          @if (auth.isAuthenticated()) {
            <a routerLink="/mi-pase" routerLinkActive="active" (click)="open.set(false)">Mi pase</a>
            <a routerLink="/sello" routerLinkActive="active" (click)="open.set(false)">Sello</a>
          }
          @if (auth.isStaff()) {
            <a routerLink="/staff" routerLinkActive="active" (click)="open.set(false)">Umbral</a>
          }
        </nav>
        <div class="header-actions">
          ...
          @if (auth.user(); as u) {
            ...
            <a class="btn btn-ghost" routerLink="/cuenta">Cuenta</a>
    ...
    <footer class="site-footer">
      <div class="wrap">La prensa no se reserva por cuarto de hora. Se sella el día.</div>
    </footer>
  `,
})
